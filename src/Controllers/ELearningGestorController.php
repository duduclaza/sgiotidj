    ...
    public function storeAula(): void
    {
        ...
        try {
            ...
            $message = $hasVideoUpload
                ? 'Aula salva com sucesso. O video sera liberado assim que o SGI STREAM concluir o processamento.'
        ...
        * { box-sizing: border-box; }
        body {
            ...
            background:
                ...
                linear-gradient(135deg, #020617, #0f172a 45%, #0f766e);
            color: #e2e8f0;
        }
        .card {
            width: min(100%, 640px);
...
<body>
    <div class="card">
        ...
        <div class="meta">
            ...
            <span class="chip">Voce pode voltar em instantes</span>
        </div>
